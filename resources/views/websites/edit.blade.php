            ...
            <form method="POST" action="{{ route('websites.update', $website) }}" class="bg-white rounded shadow border border-gray-100 p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input id="amount_paid" type="number" step="0.01" name="amount_paid" value="{{ old('amount_paid', $website->amount_paid) }}" required class="mt-1 w-full rounded-md border-gray-300 focus:ring-2 focus:ring-blue-500" />
                    </div>
                    <div class="md:col-span-2">
                        ...
                        <label class="inline-flex items-center gap-2 text-sm font-medium text-gray-700 mt-6">
                            <input type="checkbox" name="amount_includes_domain" value="1" {{ old('amount_includes_domain', $website->amount_includes_domain) ? 'checked' : '' }} class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
