...
@section('content')
    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('websites.store') }}" class="bg-white rounded shadow border border-gray-100 p-6 space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <label class="inline-flex items-center gap-2 text-sm font-medium text-gray-700">
                            <input id="domain_purchased" type="checkbox" name="domain_purchased" value="1" {{ old('domain_purchased') ? 'checked' : '' }} class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                    ...
                    <div id="domain-cost-input-wrap">
                        ...
                        <input id="domain_base_cost" type="number" step="0.01" min="0" name="domain_base_cost" value="{{ old('domain_base_cost', 0) }}" class="mt-1 w-full rounded-md border-gray-300 focus:ring-2 focus:ring-blue-500" placeholder="17.00" />
                    </div>
                    <div>
