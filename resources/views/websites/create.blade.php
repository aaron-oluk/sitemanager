    ...
    <form method="POST" action="{{ route('websites.store') }}" class="space-y-5">
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
            ...
            <div class="px-5 py-4 grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    <label class="block text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Base Cost</label>
                    <input id="amount_paid" type="number" step="0.01" min="0" name="amount_paid" value="{{ old('amount_paid') }}" required
                        class="w-full rounded-lg border-gray-300 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" placeholder="0.00" />
                </div>
                <div>
                ...
                <div>
                    <label class="block text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Tax (18%)</label>
                    <input id="hosting_tax_preview" type="text" readonly value="$0.00"
                ...
                <div>
                    ...
                    <input id="hosting_txn_preview" type="text" readonly value="$0.00"
                        class="w-full rounded-lg border-gray-200 bg-gray-50 text-sm text-gray-500" />
                </div>
                <div class="md:col-span-2">
                    <label class="block text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Total Amount Due</label>
                    <input id="hosting_total_preview" type="text" readonly value="$0.00"
