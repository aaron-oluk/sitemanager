...
@section('content')
    <header class="bg-white/80 backdrop-blur-sm border-b border-white/20">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-3">
                <a href="{{ route('websites.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded text-sm font-medium transition-colors">
                    <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                    </svg>
                    Add Website
                </a>
                <a href="{{ route('payments.create') }}" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded text-sm font-medium transition-colors">
                    <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Welcome Section -->
            <div class="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-md p-6 mb-8 text-white">
                <div class="flex items-center justify-between">
                    <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <!-- Total Websites -->
                <div class="bg-white rounded-md shadow-sm border border-gray-100 p-6 hover:shadow transition-shadow">
                    <div class="flex items-center justify-between">
                        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div class="bg-white rounded-md shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <a href="{{ route('payments.create') }}" class="flex items-center p-3 rounded hover:bg-gray-50 transition-colors">
                        ...
                        <a href="{{ route('domains.create') }}" class="flex items-center p-3 rounded hover:bg-gray-50 transition-colors">
                        ...
                        <a href="{{ route('emails.create') }}" class="flex items-center p-3 rounded hover:bg-gray-50 transition-colors">
                ...
                <div class="bg-white rounded-md shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center p-3 rounded bg-orange-50 border border-orange-100">
                            <div class="w-8 h-8 bg-orange-100 rounded flex items-center justify-center mr-3">
                                <svg class="w-4 h-4 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
