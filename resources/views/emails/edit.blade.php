            ...
            <form method="POST" action="{{ route('emails.update', $email) }}" class="bg-white rounded shadow border border-gray-100 p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="hosting_plan" class="mt-1 w-full rounded-md border-gray-300 focus:ring-2 focus:ring-blue-500">
                    ...
                    <div>
                        ...
                        <select name="associated_website" class="mt-1 w-full rounded-md border-gray-300 focus:ring-2 focus:ring-blue-500">
                    ...
                    <div>
                        ...
                        <input type="date" name="start_date" value="{{ old('start_date', optional($email->start_date)->format('Y-m-d')) }}" required class="mt-1 w-full rounded-md border-gray-300 focus:ring-2 focus:ring-blue-500" />
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Renewal Date</label>
                        <input type="date" name="renewal_date" value="{{ old('renewal_date', optional($email->renewal_date)->format('Y-m-d')) }}" required class="mt-1 w-full rounded-md border-gray-300 focus:ring-2 focus:ring-blue-500" />
                    </div>
                    <div>
