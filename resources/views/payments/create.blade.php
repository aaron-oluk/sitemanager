            ...
            <form method="POST" action="{{ route('payments.store') }}" class="bg-white rounded-2xl shadow border border-gray-100 p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="amount" id="amount" value="{{ old('amount') }}" required class="mt-1 w-full rounded-xl border-gray-300 focus:ring-2 focus:ring-blue-500" />
                    </div>
                    <div>
