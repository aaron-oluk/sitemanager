    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
        <div class="px-6 py-5 border-b border-gray-100">
            <div class="flex items-center justify-between">
                ...
                <div class="h-14 w-14 rounded-xl bg-green-50 flex items-center justify-center">
                    <svg class="w-7 h-7 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"/></svg>
                </div>
            </div>
        </div>
        <dl class="px-6 py-5 grid grid-cols-2 gap-x-8 gap-y-4">
            ...
            <div>
                ...
                <dd class="mt-1">
                    <span class="text-xs px-2 py-0.5 rounded font-medium {{ $payment->payment_type === 'domain' ? 'bg-purple-100 text-purple-700' : 'bg-blue-100 text-blue-700' }}">
